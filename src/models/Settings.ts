...
const SettingsSchema = new Schema<Settings>({
  ...
  registrationBarcodeValue: { type: String },
  invoiceEmailRecipients: { type: String },
  footerMessage: { type: String, default: 'Generated by VyaparFlow Restaurant POS' },
  thankYouNote: { type: String, default: 'Thank you. Please visit again.' },
